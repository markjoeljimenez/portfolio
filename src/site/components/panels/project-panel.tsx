								...
								<div className="panel__footer">
									...
									{this.props.settings.links.websiteLink && !this.props.settings.featured ? (
										<li className="panel__item">
											<a href={this.props.settings.links.websiteLink} className="panel__link panel__link--icon">
									...
									{this.props.settings.links.githubLink ? (
										<li className="panel__item">
											<a href={this.props.settings.links.githubLink} className="panel__link panel__link--icon">
