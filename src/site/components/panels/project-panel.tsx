						...
						<div className={`panel__content column column--md-${this.props.settings.featured ? '6' : '8'}`}>
							<div className="panel__header">
								<h2 className="panel__heading">
									{this.props.settings.path ? (
										this.props.settings.links && this.props.settings.links.websiteLink && this.props.settings.featured ? (
											<a href={this.props.settings.links.websiteLink} target="_blank" rel="noreffer">
							...
							{this.props.settings.links ? (
								<div className="panel__footer">
									...
									{this.props.settings.links.websiteLink && !this.props.settings.featured ? (
										<li className="panel__item">
											<a href={this.props.settings.links.websiteLink} className="panel__link panel__link--icon" target="_blank" rel="noreffer">
									...
									{this.props.settings.links.githubLink ? (
										<li className="panel__item">
											<a href={this.props.settings.links.githubLink} className="panel__link panel__link--icon" target="_blank" rel="noreffer">
