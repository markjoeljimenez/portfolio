...
module.exports = {
  siteMetadata: {
    ...
    socialMedia: [
      ...
      {
        link: `https://www.linkedin.com/in/mark-jimenez/`,
        name: `LinkedIn`,
      ...
      {
        link: 'https://www.twitch.tv/markjoeljimenez',
        name: 'Twitch',
        icon:
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="#fff"><path d="M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7"/></svg>',
      },
    ],
  },
  plugins: [
